...
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="#page-top">AGENDA</a>
    ...
    <div class="container px-4 px-lg-5 h-100">
        <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end">
                <h1 class="text-white font-weight-bold">One Place To Organize And Manage Your Life</h1>
                <hr class="divider" />
            </div>
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 mb-5">Agenda helps you to keep all of your tasks, notes and your secret diary in one place and you can easily manage them! Just go and have an account on Agenda</p>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <p class="text-white-75 mb-4">
                    In Agenda, you're not only writing your diary and managing your own tasks and notes, but also you're able to share them with whoever has an Agenda account
                </p>
...
<section class="page-section" id="services">
    <div class="container px-4 px-lg-5">
        <h2 class="text-center mt-0">Get Started with Your Account</h2>
        <hr class="divider" />
